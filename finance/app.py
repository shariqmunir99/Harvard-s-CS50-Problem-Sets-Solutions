...
def buy():
    if request.method == "GET":
        ...
        if stock == None:
            return apology("Symbol NON Existent")
...
def register():
    if request.method == "GET":
        ...
        #If the username isn't entered.
        if not confirmation:
            return apology("Confirmation Missing")
